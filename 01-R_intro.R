...
setwd("/Users/jose/GitHub/master_data_science")   
...
# sub only works for first replacement
# substitute $ with !
...
x <- c("2022-07-01", "2022-08-01", "2022-09-01")

as.Date(x)

y <- c("07/01/2022", "07/01/2022", "07/01/2022")
...
seq(as.Date("2010-1-1"), as.Date("2022-1-1"), by = "years")
seq(as.Date("2022/1/1"), as.Date("2022/12/30"), by = "quarter")
...
y <- as.Date("2022-09-11")
x > y
x - y

# last leap year
x <- as.Date("2022-03-1")
y <- as.Date("2022-02-28")

x - y

# example with time zones
x <- as.POSIXct("2022-01-01 01:00:00", tz = "US/Eastern")
y <- as.POSIXct("2022-01-01 01:00:00", tz = "US/Pacific")
